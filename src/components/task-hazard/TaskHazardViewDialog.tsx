      ...
      <DialogContent className="w-full max-w-4xl mx-auto h-screen sm:h-auto sm:max-h-[90vh] overflow-y-auto p-4 sm:p-6">
        <DialogHeader>
          <DialogTitle className="text-lg sm:text-xl">
            Task Hazard Assessment Details
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <ViewField label="Date" value={task.date} />
            <ViewField label="Time" value={task.time} />
            <ViewField 
              label="Status" 
              value={
            ...
            />
            <ViewField label="ID" value={task.id} />
          </div>
          ...
          {/* Asset and Location */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <ViewField label="Asset System" value={task.assetSystem} />
            <ViewField label="Location" value={task.location} />
          </div>

          {/* System Requirements */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <ViewField 
              label="System Lockout Required" 
              value={task.systemLockoutRequired ? "Yes" : "No"} 
            />
            <ViewField 
              label="Trained Workforce" 
              value={task.trainedWorkforce ? "Yes" : "No"} 
            />
          </div>
          ...
          {/* Geo Fence */}
          <ViewField 
            label="Geo Fence Limit" 
            value={`${task.geoFenceLimit || 200} Feet`} 
          />
